ifeq ($(TARGET_USES_FOSSIL_COMMON_SDM429W),true)
...
CYW_FIRMWARE_MOUNT_POINT := $(TARGET_OUT_VENDOR)/firmware_mnt/brcmfmac/sta
...
$(CYW_FIRMWARE_MOUNT_POINT):
	@echo "Creating $(FIRMWARE_MOUNT_POINT)"
	@mkdir -p $(TARGET_OUT_VENDOR)/firmware/brcmfmac/sta
	@mkdir -p $(TARGET_OUT_VENDOR)/firmware/brcmfmac/ap
ifneq ($(TARGET_MOUNT_POINTS_SYMLINKS),false)
	@ln -sf /vendor/firmware/brcmfmac/sta $(TARGET_ROOT_OUT)/firmware/brcmfmac/sta
	@ln -sf /vendor/firmware/brcmfmac/ap $(TARGET_ROOT_OUT)/firmware/brcmfmac/ap
endif
...
DUMMY_MLVM_IMAGE := $(PRODUCT_OUT)/dummy_mlvm.img
...
$(DUMMY_MLVM_IMAGE): $(AVBTOOL)
	...
	$(shell  $(AVBTOOL) add_hash_footer \
        ...
        --key $(BOARD_AVB_MLVM_BOOT_PRIV_KEY) \
        --rollback_index 0)
endif
#----------------------------------------------------------------------
...
$(warning "BOARD_PREBUILT_DTBOIMAGE: $(BOARD_PREBUILT_DTBOIMAGE)")
# Most specific paths must come first in possible_dtbo_dirs
dtbo_dir = $(BOARD_PREBUILT_DTBO_DIRS)
...
include $(BOARD_COMMON_DIR)/dtbtool/Android.mk
endif
